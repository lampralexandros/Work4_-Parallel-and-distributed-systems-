...
void bpnet::KernelapplyBatchCumulations(float alpha, float momentum,int max_neurons,int max_inputs)
{
    ...
    dim3 threadsPerBlock(number_of_layers,max_neurons);
    ...
    cuda_layer_comulations<<<1,threadsPerBlock>>>(alpha, numberOfBatches, wgain_C,errorGain_C);
    ...
    dim3 threadsPerBlock2(number_of_layers,max_neurons*max_inputs);
    ...
    cuda_layer_comulations2<<<1,threadsPerBlock2>>>( alpha, momentum, numberOfBatches, weights_C, errorWeight_C, deltavalues_C);
